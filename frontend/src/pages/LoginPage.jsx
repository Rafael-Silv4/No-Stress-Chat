...
const LoginPage = () => {
  ...
  return (
    <div className="h-dvh grid lg:grid-cols-2">
      {/* Left Side - Form */}
      <div className="flex flex-col justify-center items-center p-10 sm:p-12 h-full">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              transition-colors"
              >
                <MessageSquare className="w-8 h-6 text-primary" />
              </div>
      ...
      <AuthImagePattern
        ...
        subtitle={"Faça login para continuar suas conversas e atualizar suas mensagens."}
      />
    </div>
  );
};
